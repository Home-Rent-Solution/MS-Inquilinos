...
public class InquilinosController {
    ...
    public ResponseEntity<InquilinosResponseDTO> postInquilino(@io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Datos estructurados requeridos para" +
                    " dar de alta al inquilino", required = true)
            @Valid @RequestBody InquilinosRequestDTO dto){
        return ResponseEntity
                .status(HttpStatus.CREATED)
                .body(inquilinoService.save(dto));
    }
    ...
    public ResponseEntity<InquilinosResponseDTO> putInquilino (
            ...
            @Valid @RequestBody InquilinosRequestDTO dto){
        return ResponseEntity.ok(inquilinoService.editar(
                idInquilino,
                dto
        ));
    }
